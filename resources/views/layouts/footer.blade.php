<footer class="pb-3 mt-5 pt-10 bg-[#240750] sm:pt-16 lg:pt-24">
    <div class="mx-auto px-3 lg:px-[8px] max-w-7xl pb-16 lg:pb-0">
        <div class="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
            ...
            <div class="col-span-2 md:col-span-1 lg:col-span-2 lg:pl-8">
                <p class="text-sm font-semibold tracking-widest text-gray-400 uppercase">Kontak Kami</p>
        ...
        <hr class="mt-12 mb-10 border-gray-200" />
