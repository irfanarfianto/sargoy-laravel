        ...
        <div class="flex items-center justify-end w-full md:w-auto">
            ...
            <details class="dropdown dropdown-end">
                ...
                <ul class="menu dropdown-content bg-base-100 rounded-box z-[1] w-52 p-2 shadow">
                    <li>
                        <a href="{{ route('reviews.index', ['sort_by' => 'latest']) }}" class="flex items-center justify-between">
                            {{ __('Terbaru') }}
                    ...
                    <li>
                        <a href="{{ route('reviews.index', ['sort_by' => 'oldest']) }}" class="flex items-center justify-between">
                            {{ __('Terlama') }}
                    ...
                    <li>
                        <a href="{{ route('reviews.index', ['sort_by' => 'highest_rating']) }}" class="flex items-center justify-between">
                            {{ __('Rating Tertinggi') }}
                    ...
                    <li>
                        <a href="{{ route('reviews.index', ['sort_by' => 'lowest_rating']) }}" class="flex items-center justify-between">
                            {{ __('Rating Terendah') }}
