        ...
        <div class="bg-white overflow-hidden rounded-lg p-6 border border-base-200">
            <div class="flex items-start justify-between">
                ...
                <div class="dropdown dropdown-left dropdown-hover">
                    ...
                    <ul tabindex="0" class="dropdown-content menu bg-base-100 rounded-box z-50 w-52 p-2 shadow-lg">
                        <li>
                            <a onclick="document.getElementById('edit').showModal()">
            ...
            <div role="tablist" class="tabs tabs-lifted">
                <input type="radio" name="my_tabs_1" role="tab"
                    class="tab text-primary [--tab-bg:yellow] [--tab-border-color:orange]" aria-label="Tab 1" />
                <div role="tabpanel" class="tab-content">
                    ...
                    <p><strong>Bergabung pada:</strong> {{ $user->created_at }}</p>
                </div>
